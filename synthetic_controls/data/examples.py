...
def simulated_age_groups(seed=0):
    ...
    try:
        panel_data = pd.read_csv("./datasets/synthetic_age_groups_outcomes.csv", index_col=0)
...
def tobacco_us_states():
    ...
    try:
        panel_data = pd.read_csv("./datasets/us_states_cigarette_consumption_per_capita.csv", index_col=0)
